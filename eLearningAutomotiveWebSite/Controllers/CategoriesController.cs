...
namespace eLearningAutomotiveWebSite.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(eLearningAutomotiveWebSiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Category != null ? 
                          ...
                          Problem("Entity set 'eLearningAutomotiveWebSiteContext.Category'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'eLearningAutomotiveWebSiteContext.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
